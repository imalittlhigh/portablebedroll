...
execute positioned ^ ^ ^ if block ~ ~ ~ #pbroll:heads{SkullOwner:{Name:"$pbroll.block.bedroll"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function pbroll:place/raycast/hit
execute positioned ^1 ^ ^ if block ~ ~ ~ #pbroll:heads{SkullOwner:{Name:"$pbroll.block.bedroll"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function pbroll:place/raycast/hit
execute positioned ^-1 ^ ^ if block ~ ~ ~ #pbroll:heads{SkullOwner:{Name:"$pbroll.block.bedroll"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function pbroll:place/raycast/hit
execute positioned ^ ^1 ^ if block ~ ~ ~ #pbroll:heads{SkullOwner:{Name:"$pbroll.block.bedroll"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function pbroll:place/raycast/hit
execute positioned ^ ^-1 ^ if block ~ ~ ~ #pbroll:heads{SkullOwner:{Name:"$pbroll.block.bedroll"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function pbroll:place/raycast/hit
execute positioned ^2 ^ ^ if block ~ ~ ~ #pbroll:heads{SkullOwner:{Name:"$pbroll.block.bedroll"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function pbroll:place/raycast/hit
execute positioned ^-2 ^ ^ if block ~ ~ ~ #pbroll:heads{SkullOwner:{Name:"$pbroll.block.bedroll"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function pbroll:place/raycast/hit
execute positioned ^ ^2 ^ if block ~ ~ ~ #pbroll:heads{SkullOwner:{Name:"$pbroll.block.bedroll"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function pbroll:place/raycast/hit
execute positioned ^ ^-2 ^ if block ~ ~ ~ #pbroll:heads{SkullOwner:{Name:"$pbroll.block.bedroll"}} align xyz positioned ~0.5 ~0.5 ~0.5 run function pbroll:place/raycast/hit
